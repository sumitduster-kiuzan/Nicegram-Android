...
object NicegramPinChatsPlacementHelper {
    ...
    fun getPossiblePinChatsPlacements(context: Context) = emptyList<Any>() // Disabled ads placements
    ...
    fun pumpFeatureEnabled(context: Context) = false // Disabled ads
    fun pumpEnabled(context: Context) = false // Disabled ads
